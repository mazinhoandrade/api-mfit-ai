...
import {
  CompleteWorkoutSessionsSchema,
  ErrorSchema,
  FinishWorkoutSessionBodySchema,
...
import { FinishWorkoutSession } from "../usecases/workout-plan/finish-workout-session.js";
...
export const workoutPlanRoutes = async (app: FastifyInstance) => {
  ...
  app.withTypeProvider<ZodTypeProvider>().route({
    method: "PUT",
    url: "/:workoutPlanId/days/:workoutDayId/sessions/:sessionId/finish",
    schema: {
      operationId: "finishWorkoutSession",
      ...
      body: FinishWorkoutSessionBodySchema,
      response: {
        200: CompleteWorkoutSessionsSchema,
        401: ErrorSchema,
        404: ErrorSchema,
        409: ErrorSchema,
        500: ErrorSchema,
    ...
    handler: async (request, reply) => {
      try {
        ...
        const service = new FinishWorkoutSession();
